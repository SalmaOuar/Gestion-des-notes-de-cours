...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // Créer un enseignant
        Enseignant ens = new Enseignant("Mme Fatima", "fatima@univ.ma", "ens123", "Mathématiques");
        ed.create(ens);

        // Créer une note de cours
        NoteCours note = new NoteCours("Devoir 1", 18.5, md.findById(1), ens);
        nc.create(note);

       // Ajouter un commentaire sur la note
        CommentaireNote com = new CommentaireNote("Très bien", note, ens);
        cd.create(com);
